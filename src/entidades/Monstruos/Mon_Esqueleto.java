...
public class Mon_Esqueleto extends Entidad {
    ...
    public BufferedImage tomarImagen() {
        ...
        return switch (direccion) {
            case "izquierda" -> sprite = plantillaSprite.getImg(2, numSprite + 2, gp.getTamañofinalBaldosa());
            case "derecha" -> sprite = plantillaSprite.getImg(3, numSprite + 2, gp.getTamañofinalBaldosa());
    ...
    /**
     * metodo que dibuja el sprite en jpanel
     * @param g2d
     */
    @Override
